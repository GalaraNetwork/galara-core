...
Generates a galara.conf file in `share/examples/` by parsing the output from `galarad --help`. This script is run during the
release process to include a galara.conf with the release binaries and can also be run by users to generate a file locally.
