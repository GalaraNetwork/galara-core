...
BITCOIND=${BITCOIND:-$BINDIR/galarad}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/galara.conf}
...
then
  ...
  echo -e "To safely generate a galara.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example galara.conf file in share/examples/'
...
## Generated by contrib/devtools/gen-bitcoin-conf.sh using galarad --help.
##
...
# parse the output from galarad --help
